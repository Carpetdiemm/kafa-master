...
<body>
    ...
    <div class="content">
        ...
        <div class="profile-card">
            ...
            <p><a href="{{route('adminUpdateProfile',['student_ic'=>$data[0]->student_ic,'role'=>'student'])}}">Edit</a></p>
            <!-- Add more fields as needed -->
        </div>
        <br>
        <div class="profile-card">
            <h2>Parent Profile</h2> 
            <p><b>Name:</b> {{ $data2[0]->name }}</p>
            <p><b>Phone Number:</b> {{$data2[0]->parent_phone_numb}}</p>
            <p><b>Email:</b> {{ $data2[0]->email }}</p>
            <p><b>Role:</b> {{ ($data2[0]->userrole) == 'parentStudent' ? 'Parent' : 'Admin' }}</p>
            <p><a href="{{route('adminUpdateProfile',['student_ic'=>$data[0]->student_ic,'role'=>'parent'])}}">Edit</a></p>
            <!-- Add more fields as needed -->
        </div>
